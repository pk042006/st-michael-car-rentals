...
export const Input = forwardRef<HTMLInputElement, InputProps>(({ label, error, helperText, className, id, ...props }, ref) => {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input id={inputId} ref={ref} className={cn('w-full px-4 py-2.5 rounded-lg border bg-white text-gray-900 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-[#c9a84c] focus:border-transparent transition-all', error ? 'border-red-400' : 'border-gray-300', className)} {...props} />
